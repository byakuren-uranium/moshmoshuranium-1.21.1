package com.sirenensemble.sculktechnologies.items.armor;
...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> SCULK_ARMOR_MATERIAL = register("sculk",
            ...
            }), 26, 3f, 0.5f, () -> ModItems.SCULK_ORE.get());


    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(SculkTechnologies.MODID, name);
