package com.sirenensemble.sculktechnologies.blocks.blockentity.renderer;
...
public class ExpSculkConverterRenderer implements BlockEntityRenderer<ExpSculkConverterEntity> {

    public ExpSculkConverterRenderer(BlockEntityRendererProvider.Context context){

    }


    @Override
    public void render(ExpSculkConverterEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
